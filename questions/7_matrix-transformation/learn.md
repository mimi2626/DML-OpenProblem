...
(Multiplying by non-invertable $S$ would result in a loss of dimensions)

### Steps for Transformation

Given matrices $A$, $T$, and $S$:

1. **Check Invertibility**: Verify that $T$ and $S$ are invertible by ensuring their determinant is non-zero; otherwise, return $-1$.
